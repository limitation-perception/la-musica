...
lyrics_dict = {"on_the_floor.mp3": r"C:\Users\User\PycharmProjects\PythonProject5\music\on_the_floor.txt",
               "tears.mp3": r"C:\Users\User\PycharmProjects\PythonProject5\music\tears.txt",
               "hey_baby.mp3": r"C:\Users\User\PycharmProjects\PythonProject5\music\hey_baby.txt",
               "beat_it.mp3": r"C:\Users\User\PycharmProjects\PythonProject5\music\beat_it.txt"}
...
def graphic():
    ...
    ax.hist(
        file,
        bins=range(min(file), max(file) + 2),
        edgecolor="black",
        color="skyblue",
        rwidth=0.9,
        align="left"
    ...
    Path("templates/images/static").mkdir(exist_ok=True)
    plt.savefig("templates/static", bbox_inches="tight")
